...
const AuthScreen = () => {
  ...
  return (
    <div className='hero-bg relative'>
        ...
        {/*Hero section */}
        <div className='flex flex-col items-center justify-center text-center py-40 text-white mac-w-6xl mx-auto'>
            <h1 className='text-5xl md-text-6xl font-bold mb-4'>Unlimited movies, TV</h1>
            <h1 className='text-5xl md-text-6xl font-bold mb-4'>shows and more</h1>
			...
			/>
                <button
					className='bg-red-600 text-xl lg:text-2xl px-2 lg:px-6 py-1 md:py-2 rounded flex justify-center
					items-center'>
					Get Started
            ...
            <div className='flex max-w-6xl mx-auto items-center justify-center md:flex-row flex-col-reverse px-4 md:px-2'>
                ...
                <div className='flex-1 '>
                    <div className='relative'>
                        ...
                        w-3/4 lg:w-1/2 h-24 border border-slate-500 rounded-md p-4
                        '>
            ...
            <div className='py-10 bg-black text-white'>
                ...
                <div className='py-10 bg-black text-white'> 
                    ...
                    <div className='flex-1 md:'> 
                        ...
                        <p className='text-lg md:text-xl'>
                            Send your kids on adventures with their favorite characters in a space made just for them-free with your membership 
                        </p>
                    </div>            
                </div>
            </div>
